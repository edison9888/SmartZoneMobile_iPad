    //
//  FAQCommentWriteViewController.m
//  MobileKate2.0_iPad
//
...
@implementation FAQCommentWriteViewController
		...
		if (interfaceOrientation == UIInterfaceOrientationLandscapeLeft || interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
			...
			if (nicknameFlag == YES) {
				if ([self.contentView isFirstResponder]) {
					...
					frame = CGRectMake(10, 205, 530, 180);
					frame2 = CGRectMake(9, 205, 523, 186);
				} else {
					// 가로모드이고 비실명작성이며 키보드 안올라옴
					frame = CGRectMake(10, 205, 530, 325);
					frame2 = CGRectMake(9, 205, 523, 406);
				}
			} else {
				if ([self.contentView isFirstResponder]) {
			...
			if (nicknameFlag == YES) {
				if ([self.contentView isFirstResponder]) {
					frame = CGRectMake(10, 205, 530, 356);
					frame2 = CGRectMake(9, 205, 523, 336);
				} else {
					frame = CGRectMake(10, 205, 530, 436);
					frame2 = CGRectMake(9, 205, 523, 406);
				}
	...
	if([self.contentView.text length] > 0) {
		if ([self.nicknameSwitch isOn]) {
			if([self.nicknameField.text length] > 0) {
				...
				//UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"알림" message:@"비실명 작성시 비실명을 입력하셔야 합니다."
		...
		switch (self.writeMode) {
			...
			case 1: // answar mode
				...
				//NSLog(@"%d, %d", depthtemp, depthtemp++);
				
				[requestDictionary setObject:[NSString stringWithFormat:@"%d", depthtemp] forKey:@"depth"];
...
- (BOOL)textViewShouldEndEditing:(UITextView *)textView {
	...
	if (nicknameFlag == YES) {
		frame = CGRectMake(10, 205, 530, 436);
		frame2 = CGRectMake(9, 205, 523, 406);
		frame3 = CGRectMake(0, 177, 540, 21);
		frame4 = CGRectMake(19, 209, 211, 21);
	} else {
		frame = CGRectMake(10, 163, 530, 396+82);
		frame2 = CGRectMake(9, 163, 523, 366+82);
		frame3 = CGRectMake(0, 135, 540, 21);//
